"""
Django settings for parallelapp_chrome_45978 project.
...
ROOT_URLCONF = 'parallelapp_chrome_45978.urls'
...
WSGI_APPLICATION = 'parallelapp_chrome_45978.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "parallelapp_chrome_45978 API",
    "DESCRIPTION": "API documentation for parallelapp_chrome_45978 App",
    "VERSION": "v1",
}
